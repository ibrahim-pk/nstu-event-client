      ...
      <section className="">
            ...
            <div>
              ...
              <div className="container">
                <form onSubmit={e => onSubmit(e)}>
                  ...
                  <textarea className="form-control"  type="Information"
                    ...
                    <textarea className="form-control"  type="Location"
        ...
        <div className="form-group">
                  ...
                  />
                    ...
                    <br />
                  <center>
                  <input type="submit" className="btn btn-info"value="Submit" style={{textALign:"center",width:"120px",backgroundColor:"lightBlue", height:"40px"}}/>
                  </center>
                </form>
              </div>
            </div>
