            ...
            <div className="">
              <div className="">
                ...
                <div className="main_container">
                  <div className="jumbotron text-center" style={{backgroundColor:"lightblue", height:"110px"}}>
                    ...
                    <label>Your Interests</label>
                      ...
                      <div className="form-group">
                        ...
                        <input
                          ...
                          onChange={e => onChange(e)}
                        />
                        <div id="invalid_SACCode" className="error_msg">
                          {" "}
                        </div>
                      </div>
                      <div className="form-group ">
                        ...
                        <input
                          ...
                          id="Quantity"
                        />
                        <div id="invalid_Quantity" className="error_msg">
                          {" "}
                        </div>
                      </div>
