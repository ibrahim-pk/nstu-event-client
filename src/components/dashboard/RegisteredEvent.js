        ...
        <div className="card" style={{border: "none" }}>
          ...
          <div className="card_content " style={{ height: "50px"}}>
            ...
            <div className="row">
              ...
              90%  <i className="fas fa-heart fa-lg" style={{color:"#FF1493"}}> </i> | {props.venue.location}     |     {props.venue.age}
              </p>
  ...
  render() {
    return (     
      ...
      <Navbar></Navbar>   
        ...
        {
          this.state.events.length>0? <div className='text-center'>
          <button className="" style={{textDecoration:"none "}} href="#" ><Link to={'/cancel/'+ this.props.match.params.id}>Cancel your event</Link></button>
          </div>:<h1 className='text-center'>There is no event list.</h1>
        }
