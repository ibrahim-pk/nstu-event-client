      ...
      <div className="card" style={{ border: "none" }}>
        <div className="card_image" style={{ width: "220px" }}>
          ...
          <Link to={'/gotoprofile/'+props.events._id}>
            <img style={{ width: "230px", height: "250px" }} src={props.events.avatar} />{" "}
...
export default class SearchPeople extends Component {
  ...
  */
  ...
  render() {
    ...
    <input type="image" className="search-icon"  src="http://www.endlessicons.com/wp-content/uploads/2012/12/search-icon.png" value='Send'></input>
  </form>
