...
<div >
    ...
    <div className="event-page-header__poster event-poster-image2">
            ...
            <div className="event-poster-infobar">
                <ul className="event-wherewhen">
                    <li>
                        ...
                        <span className="data-tag-white">{this.state.location}</span>
                    </li>
                    <li>
                        <p className="countdown-number" style={{color:"white"} }><FontAwesomeIcon icon={faChair} /> </p>
                        <span className="data-tag-white">{this.state.type}</span>
                    </li>
                    <li>
    ...
    <div className="event-page-header__context">
        <div className="event-page-title">
            <Link className="event-category-tag" to={'/SearchVenue/'}>See Other Venues</Link>
            <div className="row">
        ...
        <input className="btn btn-cta" style={{fontSize:"2rem", color:"white"}} href="#" type='submit' value='register'className='bouton' ></input>
        </form>
...
<div className="event-page-content">
  ...
  <div className="row no-gutters">
    <div className="col-md-4">
      <img src={host} className="card-img" />
    </div>
    <div className="col-md-8">
      <div className="card-body">
        <h3 className="card-title">About the Host <i style={{color:"skyBlue"}}className="fas fa-check-square"></i></h3>
        <p className="card-text" style={{padding:"2px"}}>Hey everyone, Ishita here. From here on out I will be your main point of contact for your adventure! We like to offer outside-the-box travel experiences, not stuffy off-the-shelf tours.</p>
       </div>
      </div>
    </div>
  </div>
