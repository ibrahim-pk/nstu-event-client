      ...
      <div className="card" style={{ border: "none" }}>
        ...
        <div className="card_image" style={{ width: "220px" }}>
          ...
          <button
              ...
              >
                <i className="fas fa-heart fa-lg" style={{color: "#FF1493", width:"20px", height:"20px" }}></i>
              </button>
          </div>
          </Link>
          </div>
...
export default class SearchEvents extends Component {
  ...
  exerciseList() {
    return this.state.events.map((currentexercise) =>currentexercise.status!=='Cancelled'&&<Events events={currentexercise} key={currentexercise._id} />
    );
  }
  ...
  render() {
          ...
          <div className="row">
            <div className="col">
              ...
              <form className="search-container" onSubmit={this.onSubmit}>
                  ...
                  ></input>
          {/* <button type="button" className="btn btn-default" style={{border:"None"}} value="Send">
    <span className="glyphicon glyphicon-search" ></span>  
              ...
              <div className="container  " >
                <div className="row">
                  <div className="col-2 h-50 d-inline-block" style={{backgroundColor: "#EFF9FC"}}>
              ...
              <img src={video1} style={{position:"center",marginTop:"20px",width: "130px", marginBottom:"20px", height: "180px"}}>
                  ...
                  <div className="col-10">{this.exerciseList()}</div>
                </div>
              </div>
            </div>
          </div>
